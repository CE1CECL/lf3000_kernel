...
/* Enable this #define if you want the CART NAND on nNCS[0] */
#define CABO_CART_NAND_ON_nNCS0	1

#ifdef CABO_CART_NAND_ON_nNCS0

#define LF2000_BASE_NAND_BANK	1
#define LF2000_CART_NAND_BANK	0

#else	/* CART NAND on nNCS[1] */
...
struct lf2000_nand_data {
	...
	struct mtd_info		mtd;
	int			nand_bank;
	int			hw_ecc_level;	/* 3-bit value for the
						   NFCONTROL reg's NFECCMODE
						   field. */
