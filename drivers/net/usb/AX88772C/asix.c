...
/* RALFARO -- commenting out MAC address retieval from EEPROM due to ConnMan issuing a reset. */
/*	void *buf;
...
*/
	...
	/* Set the MAC address */
/* RALFARO -- 'dev->net->dev_addr' still holds the previously used MAC address...reuse it! */
...
/* RALFARO -- following is not needed due to above changes. */
//	kfree(buf);
	return ret;
}
...
static const struct usb_device_id products[] = {
{
	...
	/* ASIX AX88772C ver.1 10/100 */
	USB_DEVICE_VER(0x0b95, 0x772C, 0, 2),
	.driver_info = (unsigned long) &ax88772c_info,
},
