...
#define DEVICE_DRIVER_RELEASE_VERSION   ("6.7.0.0")
...
#define CFG_IO_TOUCH_SCREEN_RESET	(((1 * 32) + 24))
#define REST_GPIO (CFG_IO_TOUCH_SCREEN_RESET)
#define IRQ (((1 * 32) + 25))

#define MS_TS_MSG_IC_GPIO_RST   REST_GPIO //RK30_PIN0_PB6
#define MS_TS_MSG_IC_GPIO_INT   IRQ //RK30_PIN1_PB7
