...
static int nxp_video_overlay(struct file *file, void *fh,
	unsigned int i)
{
    pr_debug("%s\n", __func__);
	return 0;
...
static int nxp_video_get_fbuf(struct file *file, void *fh,
...
static int nxp_video_set_fbuf(struct file *file, void *fh,
			struct v4l2_framebuffer *a)
{
    pr_debug("%s\n", __func__);
	return 0;
...
static struct v4l2_ioctl_ops nxp_video_ioctl_ops = {
    ...
    .vidioc_overlay                 = nxp_video_overlay,
    .vidioc_g_fbuf                  = nxp_video_get_fbuf,
    .vidioc_s_fbuf                  = nxp_video_set_fbuf,
};
