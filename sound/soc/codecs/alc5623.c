...
static const struct snd_kcontrol_new alc5621_vol_snd_controls[] = {
	SOC_DOUBLE_TLV("Master Playback Volume",
			ALC5623_STEREO_DAC_VOL, 8, 0, 31, 1, hp_tlv),
...
//    ALC5625_write_IIC(client,0x02,0x8080);
    ...
    ALC5625_write_IIC(client,0x3E,0x9E0A);
    ALC5625_write_IIC(client,0x34,0x8000);
//    ALC5625_write_IIC(client,0x0C,0x4808);
    ALC5625_write_IIC(client,0x1C,0xAB00); //AF00 class d  //9f00
//    ALC5625_write_IIC(client,0x02,0x0000);
//    ALC5625_write_IIC(client,0x04,0x0000);
    ALC5625_write_IIC(client,0x10,0xE0E0);
    ALC5625_write_IIC(client,0x22,0x0800); // mic1 boost +30db
    ALC5625_write_IIC(client,0x14,0x3F3F);
    ALC5625_write_IIC(client,0x12,0xF58B); //FF9F FB16 F58B

//	ALC5625_write_IIC(client,0x02,0x0404);
//	ALC5625_write_IIC(client,0x0C,0x2808);
	ALC5625_write_IIC(client,0x4C,0x140E);
	ALC5625_write_IIC(client,0x4E,0x140E);
	ALC5625_write_IIC(client,0x3C,0x67CB);
...
static struct snd_soc_codec_driver soc_codec_device_alc5623 = {
	...
	.controls = alc5623_snd_controls,
	.num_controls = ARRAY_SIZE(alc5623_snd_controls),
