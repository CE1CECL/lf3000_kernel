...
export NXP4330_REPOSITORY=$HOME/workspace/nxp4330_bsp/TRUNK
...
export ARCH=arm
export LINUX_VERSION=3.4.5
export MODULES_PATH=$NXP4330_REPOSITORY/kernel/linux-$LINUX_VERSION/mymodules
export LOCALVERSION=
