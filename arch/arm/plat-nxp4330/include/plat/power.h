...
#define CRITICAL_BATTERY_MV	3570	/* critical battery			*/
...
#endif //CONFIG_PLAT_NXP4330_BOGOTA

#ifdef CONFIG_PLAT_NXP4330_SANTIAGO//Santiago
/* default values */
/* SP 04-16-13: If you are changing low battery threshold here, 
 * make sure you also change it in these two files to maintain it 
 * across boot, kernel and battery voltage logging.
 ...
 * Boot - nxp3200_bsp/bootloader/u-boot-2010.06/board/nxp3200/common/board.c
 */
#define MAX_BATTERY_MV	4200		/* max expected battery value	*/
#define LOW_BATTERY_MV	3645		/* low battery			*/
#define LOW_BATTERY_REPEAT_MV 25	/* repeat every 100mv drop	*/
#define CRITICAL_BATTERY_MV	3550	/* critical battery			*/
#define BATTERY_DOWN_MV	3500		/* battery shutdown			*/
...
#define	BATTERY_0	3550
#define	BATTERY_5	3555
#define	BATTERY_25	3665
#define	BATTERY_50	3726
#define	BATTERY_75	3858
