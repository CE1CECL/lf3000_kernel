...
static struct disp_vsync_info	lcd_vsync = {
	...
	.clk_src_lv0	= CFG_DISP_PRI_CLKGEN0_SOURCE,
	.clk_div_lv0	= 87, //CFG_DISP_PRI_CLKGEN0_DIV,
	.clk_src_lv1	= CFG_DISP_PRI_CLKGEN1_SOURCE,
	.clk_div_lv1	= CFG_DISP_PRI_CLKGEN1_DIV,
};
...
static struct disp_vsync_info	lcd_vsync = {
	...
	.v_sync_invert	= 0,	//CFG_DISP_PRI_VSYNC_ACTIVE_HIGH,
	.pixel_clock_hz	= 44000000, //CFG_DISP_PRI_PIXEL_CLOCK,
	.clk_src_lv0	= CFG_DISP_PRI_CLKGEN0_SOURCE,
	.clk_div_lv0	= 18, //CFG_DISP_PRI_CLKGEN0_DIV,
	.clk_src_lv1	= CFG_DISP_PRI_CLKGEN1_SOURCE,
	.clk_div_lv1	= CFG_DISP_PRI_CLKGEN1_DIV,
};
...
#if defined (CONFIG_NEXELL_SOC_DISP_LCDIF)
	.vsync	     	= &lcd_vsync,
#elif defined (CONFIG_NEXELL_SOC_DISP_LVDS)
	.vsync	     	= &lvds_vsync,
#endif
};
...
static struct nxp_fb_plat_data sec_fb_plat_data = {
	.module			= 1,
	.layer			= 0, //CFG_DISP_SEC_SCREEN_LAYER,
	.format			= MLC_RGBFMT_A8R8G8B8, //CFG_DISP_SEC_SCREEN_RGB_FORMAT,
	.bgcolor		= 0xFF, //CFG_DISP_SEC_BACK_GROUND_COLOR,
	.bitperpixel	= 32, 	//CFG_DISP_SEC_SCREEN_PIXEL_BYTE * 8,
	.x_resol		= 1280, //CFG_DISP_SEC_RESOL_WIDTH,
	.y_resol		= 720,  //CFG_DISP_SEC_RESOL_HEIGHT,
#ifdef CONFIG_ANDROID
	.buffers		= 3,
#elif defined(CONFIG_FB_NEXELL_ION_MEM)
	.buffers		= 4,
