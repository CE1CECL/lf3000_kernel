...
int s5p_usb_phy_init(struct platform_device *pdev, int type)
{
	...
	printk( KERN_INFO "<<<<<<<<<<<<<<<<<<<<<<<<<<<< USB_PHY_INIT\n" );
	if( type == S5P_USB_PHY_HOST )
	{
		printk( KERN_INFO "<<<<<<<<<<<<<<<<<<<<<<<<<<<< USB_PHY_HOST init\n" );
// juno : 추수 함수로 뺄 것...
//		if (pdata->phy_init)
//			pdata->phy_init(pdev, S5P_USB_PHY_HOST);

		// Release common reset of host controller
		writel(readl(0xf0012004) & ~(1<<24), 0xf0012004);			// reset on
		writel(readl(0xf0012004) |  (1<<24), 0xf0012004);			// reset off
//		NX_CONSOLE_Printf( "\nRSTCON[24](0xf0012004) set 1'b1 0x%08x\n", readl( 0xf0012004 ) );

		// Program AHB Burst type
		writel(readl(0xf001101c) & ~(7<<25), 0xf001101c);
		writel(readl(0xf001101c) |  (7<<25), 0xf001101c);
//		NX_CONSOLE_Printf( "TIEOFFREG7[27:25](0xf001101c) set 3'b111 0x%08x\n", readl( 0xf001101c ) );

		// Select word interface and enable word interface selection
		writel(readl(0xf0011014) & ~(3<<25), 0xf0011014);
		writel(readl(0xf0011014) |  (3<<25), 0xf0011014);			// 2'b01 8bit, 2'b11 16bit word
//		NX_CONSOLE_Printf( "TIEOFFREG5[26:25](0xf0011014) set 2'b11 0x%08x\n", readl( 0xf0011014 ) );

		writel(readl(0xf0011024) & ~(3<<8), 0xf0011024);
		writel(readl(0xf0011024) |  (3<<8), 0xf0011024);				// 2'b01 8bit, 2'b11 16bit word
//		NX_CONSOLE_Printf( "TIEOFFREG9[10:9](0xf0011024) set 2'b11 0x%08x\n", readl( 0xf0011024 ) );

		// POR of PHY
		writel(readl(0xf0011020) & ~(3<<7), 0xf0011020);
		writel(readl(0xf0011020) |  (1<<7), 0xf0011020);
//		NX_CONSOLE_Printf( "TIEOFFREG8[8:7](0xf0011020) set 2'b01 0x%08x\n", readl( 0xf0011020 ) );

		// Wait clock of PHY - about 40 micro seconds
		udelay(100); // 40us delay need.

		// Release utmi reset
		writel(readl(0xf0011014) & ~(3<<20), 0xf0011014);
		writel(readl(0xf0011014) |  (3<<20), 0xf0011014);
//		NX_CONSOLE_Printf( "TIEOFFREG5[21:20](0xf0011014) set 2'b11 0x%08x\n", readl( 0xf0011014 ) );

		//Release ahb reset of EHCI, OHCI
		writel(readl(0xf0011014) & ~(7<<17), 0xf0011014);
		writel(readl(0xf0011014) |  (7<<17), 0xf0011014);
//		NX_CONSOLE_Printf( "TIEOFFREG13[19:17](0xf0011014) set 3'b111 0x%08x\n", readl( 0xf0011014 ) );
...
//			ret = exynos5_usb_phy30_init(pdev);
	...
	{
		printk( KERN_INFO "<<<<<<<<<<<<<<<<<<<<<<<<<<<< USB_PHY_DEVICE init\n" );
#if 0
		writel(readl(0xf0012004) & ~(1<<25), 0xf0012004);           // reset on
		writel(readl(0xf0012004) | (1<<25), 0xf0012004);            // reset off
		...
		udelay(1); // 10 clock need
#else
		// Release otg common reset
		writel(readl(0xf0012004) & ~(1<<25), 0xf0012004);			// reset on
		writel(readl(0xf0012004) |  (1<<25), 0xf0012004);			// reset off
		printk( "\nRSTCON[25](0xf0012004) set 1'b1 0x%08x\n", readl( 0xf0012004 ) );

		// Program scale mode to real mode
		writel(readl(0xf0011030) & ~(3<<0), 0xf0011030);
//		writel(readl(0xf0011030) |  (0<<0), 0xf0011030);
		printk( "TIEOFFREG7[27:25](0xf0011030) set 3'b111 0x%08x\n", readl( 0xf0011030 ) );

		// Select word interface and enable word interface selection
		writel(readl(0xf0011038) & ~(3<<8), 0xf0011038);
		writel(readl(0xf0011038) |  (3<<8), 0xf0011038);			// 2'b01 8bit, 2'b11 16bit word
		printk( "TIEOFFREG5[26:25](0xf0011038) set 2'b11 0x%08x\n", readl( 0xf0011038 ) );

		writel(0xA3006C00, 0xf0011034);
		writel(0xA3006C80, 0xf0011034);

		udelay(40); // 40us delay need.

//		pTieoffreg->TIEOFFREG[13] = 0xA3006C88; // nUtmiResetSync : 00000001
		writel(0xA3006C88, 0xf0011034);

		udelay(1); // 10 clock need

//		pTieoffreg->TIEOFFREG[13] = 0xA3006C8C; // nResetSync : 00000001
		writel(0xA3006C8C, 0xf0011034);

		udelay(1); // 10 clock need
/*
		// Select VBUS
		writel(readl(0xf0011034) & ~(3<<24), 0xf0011034);
		writel(readl(0xf0011034) |  (3<<24), 0xf0011034);				// 2'b00 Analog, 2'b11 Digital
		printk( "TIEOFFREG9[10:9](0xf0011034) set 2'b11 0x%08x\n", readl( 0xf0011034 ) );

		// POR of PHY
		writel(readl(0xf0011034) & ~(3<<7), 0xf0011034);
		writel(readl(0xf0011034) |  (1<<7), 0xf0011034);
		printk( "TIEOFFREG8[8:7](0xf0011034) set 2'b01 0x%08x\n", readl( 0xf0011034 ) );

		// Wait clock of PHY - about 40 micro seconds
		udelay(100); // 40us delay need.

		// Release utmi reset
		writel(readl(0xf0011034) & ~(1<<3), 0xf0011034);
		writel(readl(0xf0011034) |  (1<<3), 0xf0011034);
		printk( "TIEOFFREG5[21:20](0xf0011034) set 2'b11 0x%08x\n", readl( 0xf0011034 ) );

		//Release ahb reset of EHCI, OHCI
		writel(readl(0xf0011034) & ~(1<<2), 0xf0011034);
		writel(readl(0xf0011034) |  (1<<2), 0xf0011034);
		printk( "TIEOFFREG13[19:17](0xf0011034) set 3'b111 0x%08x\n", readl( 0xf0011034 ) );
*/
#endif
