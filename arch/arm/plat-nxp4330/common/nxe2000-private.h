...
#define	NXE2000_REG_DC2_SLOT			0x17
#define	NXE2000_REG_DC3_SLOT			0x18
#define	NXE2000_REG_LDO1_SLOT			0x1B
#define	NXE2000_REG_LDO2_SLOT			0x1C
#define	NXE2000_REG_LDO3_SLOT			0x1D
#define	NXE2000_REG_LDO4_SLOT			0x1E
#define	NXE2000_REG_LDO5_SLOT			0x1F
#define	NXE2000_REG_PSO0_SLOT			0x25
#define	NXE2000_REG_PSO1_SLOT			0x26
#define	NXE2000_REG_PSO2_SLOT			0x27
#define	NXE2000_REG_PSO3_SLOT			0x28
#define	NXE2000_REG_LDORTC1_SLOT		0x2A
/* DCDC */
...
#define	NXE2000_REG_DC1DAC				0x36
#define	NXE2000_REG_DC2DAC				0x37
#define	NXE2000_REG_DC3DAC				0x38
#define	NXE2000_REG_DC4DAC				0x39
#define	NXE2000_REG_DC5DAC				0x3A
#define	NXE2000_REG_DC1DAC_SLP			0x3B
#define	NXE2000_REG_DC2DAC_SLP			0x3C
#define	NXE2000_REG_DC3DAC_SLP			0x3D
#define	NXE2000_REG_DC4DAC_SLP			0x3E
#define	NXE2000_REG_DC5DAC_SLP			0x3F
...
#define	NXE2000_REG_LDO1DAC				0x4C
#define	NXE2000_REG_LDO2DAC				0x4D
#define	NXE2000_REG_LDO3DAC				0x4E
#define	NXE2000_REG_LDO4DAC				0x4F
#define	NXE2000_REG_LDO5DAC				0x50
#define	NXE2000_REG_LDO6DAC				0x51
#define	NXE2000_REG_LDO7DAC				0x52
#define	NXE2000_REG_LDO8DAC				0x53
#define	NXE2000_REG_LDO9DAC				0x54
#define	NXE2000_REG_LDO10DAC			0x55
#define	NXE2000_REG_LDORTC1DAC			0x56
#define	NXE2000_REG_LDORTC2DAC			0x57
#define	NXE2000_REG_LDO1DAC_SLP			0x58
#define	NXE2000_REG_LDO2DAC_SLP			0x59
#define	NXE2000_REG_LDO3DAC_SLP			0x5A
#define	NXE2000_REG_LDO4DAC_SLP			0x5B
#define	NXE2000_REG_LDO5DAC_SLP			0x5C
#define	NXE2000_REG_LDO6DAC_SLP			0x5D
#define	NXE2000_REG_LDO7DAC_SLP			0x5E
#define	NXE2000_REG_LDO8DAC_SLP			0x5F
#define	NXE2000_REG_LDO9DAC_SLP			0x60
#define	NXE2000_REG_LDO10DAC_SLP		0x61
/* ADC */
...
#define	NXE2000_POS_PSWR_RESET				(4)
...
/* DC1CTL */
#define	NXE2000_POS_DC1CTL_DC1MODE_SLP		(6)
#define	NXE2000_POS_DC1CTL_DC1MODE			(4)
#define	NXE2000_POS_DC1CTL_DC1DIS			(1)
#define	NXE2000_POS_DC1CTL_DC1EN			(0)

/* DC1CTL2 */
#define	NXE2000_POS_DC1CTL2_DC1OSC			(6)
#define	NXE2000_POS_DC1CTL2_DC1SR			(4)
#define	NXE2000_POS_DC1CTL2_DC1LIM			(1)
#define	NXE2000_POS_DC1CTL2_DC1LIMSDEN		(0)

/* DC2CTL */
#define	NXE2000_POS_DC2CTL_DC2MODE_SLP		(6)
#define	NXE2000_POS_DC2CTL_DC2MODE			(4)
#define	NXE2000_POS_DC2CTL_DC2DIS			(1)
#define	NXE2000_POS_DC2CTL_DC2EN			(0)

/* DC2CTL2 */
#define	NXE2000_POS_DC2CTL2_DC2OSC			(6)
#define	NXE2000_POS_DC2CTL2_DC2SR			(4)
#define	NXE2000_POS_DC2CTL2_DC2LIM			(1)
#define	NXE2000_POS_DC2CTL2_DC2LIMSDEN		(0)

/* DC3CTL */
#define	NXE2000_POS_DC3CTL_DC3MODE_SLP		(6)
#define	NXE2000_POS_DC3CTL_DC3MODE			(4)
#define	NXE2000_POS_DC3CTL_DC3DIS			(1)
#define	NXE2000_POS_DC3CTL_DC3EN			(0)

/* DC3CTL2 */
#define	NXE2000_POS_DC3CTL2_DC3OSC			(6)
#define	NXE2000_POS_DC3CTL2_DC3SR			(4)
#define	NXE2000_POS_DC3CTL2_DC3LIM			(1)
#define	NXE2000_POS_DC3CTL2_DC3LIMSDEN		(0)
...
/* LDOEN2 */
#define	NXE2000_POS_LDOEN2_LDORTC2			(5)
#define	NXE2000_POS_LDOEN2_LDORTC1			(4)

/* LDODIS */
#define	NXE2000_POS_LDODIS_LDO5DIS			(4)
#define	NXE2000_POS_LDODIS_LDO4DIS			(3)
#define	NXE2000_POS_LDODIS_LDO3DIS			(2)
#define	NXE2000_POS_LDODIS_LDO2DIS			(1)
#define	NXE2000_POS_LDODIS_LDO1DIS			(0)
...
#define	NXE2000_POS_ADCCNT3_AVE				(2)
#define	NXE2000_POS_ADCCNT3_ADSEL			(0)

/* EN_ADCIR1 */
#define	NXE2000_POS_EN_ADCIR1_AIN0LIR		(7)
#define	NXE2000_POS_EN_ADCIR1_AIN1LIR		(6)
#define	NXE2000_POS_EN_ADCIR1_VTHMLIR		(5)
#define	NXE2000_POS_EN_ADCIR1_VSYSLIR		(4)
#define	NXE2000_POS_EN_ADCIR1_VUSBLIR		(3)
#define	NXE2000_POS_EN_ADCIR1_VADPLIR		(2)
#define	NXE2000_POS_EN_ADCIR1_VBATLIR		(1)
#define	NXE2000_POS_EN_ADCIR1_ILIMLIR		(0)

/*  EN_ADCIR2 */
#define	NXE2000_POS_EN_ADCIR2_AIN0HIR		(7)
#define	NXE2000_POS_EN_ADCIR2_AIN1HIR		(6)
#define	NXE2000_POS_EN_ADCIR2_VTHMHIR		(5)
#define	NXE2000_POS_EN_ADCIR2_VSYSHIR		(4)
#define	NXE2000_POS_EN_ADCIR2_VUSBHIR		(3)
#define	NXE2000_POS_EN_ADCIR2_VADPHIR		(2)
#define	NXE2000_POS_EN_ADCIR2_VBATHIR		(1)
#define	NXE2000_POS_EN_ADCIR2_ILIMHIR		(0)

/*  EN_ADCIR3 */
#define	NXE2000_POS_EN_ADCIR3_ADCENDIR		(0)

/* IR_ADC1 */
#define	NXE2000_POS_IR_ADC1_AIN0L			(7)
#define	NXE2000_POS_IR_ADC1_AIN1L			(6)
#define	NXE2000_POS_IR_ADC1_VTHML			(5)
#define	NXE2000_POS_IR_ADC1_VSYSL			(4)
#define	NXE2000_POS_IR_ADC1_VUSBL			(3)
#define	NXE2000_POS_IR_ADC1_VADPL			(2)
#define	NXE2000_POS_IR_ADC1_VBATL			(1)
#define	NXE2000_POS_IR_ADC1_ILIML			(0)

/* IR_ADC2 */
#define	NXE2000_POS_IR_ADC2_AIN0H			(7)
#define	NXE2000_POS_IR_ADC2_AIN1H			(6)
#define	NXE2000_POS_IR_ADC2_VTHMH			(5)
#define	NXE2000_POS_IR_ADC2_VSYSH			(4)
#define	NXE2000_POS_IR_ADC2_VUSBH			(3)
#define	NXE2000_POS_IR_ADC2_VADPH			(2)
#define	NXE2000_POS_IR_ADC2_VBATH			(1)
#define	NXE2000_POS_IR_ADC2_ILIMH			(0)

/* IR_ADC3 */
#define	NXE2000_POS_IR_ADC3_ADCEND			(0)
...
enum nxe2000_irq {
	...
	NXE2000_IRQ_ADC1_VADPL,
	NXE2000_IRQ_ADC1_VBATL,
	NXE2000_IRQ_ADC1_ILIML,			/* 10 */
	...
	NXE2000_IRQ_ADC2_ILIMH,

	NXE2000_IRQ_ADC3_END,

	NXE2000_IRQ_GPIO_GP00,			/* 20 */
	...
	NXE2000_IRQ_CHGCTRL_VUSBLVS,
	NXE2000_IRQ_CHGCTRL_VADPLVS,
	NXE2000_IRQ_CHGCTRL_VUSBDETS,
	NXE2000_IRQ_CHGCTRL_VADPDETS,	/* 30 */
	...
	NXE2000_IRQ_CHGSTS_CHGCMP,
	NXE2000_IRQ_CHGSTS_ONCHG,

	NXE2000_IRQ_CHGSTS_OSCMDET,
	NXE2000_IRQ_CHGSTS_OSCFDET3,	/* 40 */
	...
	NXE2000_IRQ_CHGERR_VUSBOVS,
	NXE2000_IRQ_CHGERR_VADPOVS,
	NXE2000_IRQ_CHGERR_RTIMOV,
	NXE2000_IRQ_CHGERR_TTIMOV,		/* 50 */
...
extern int nxe2000_read_reg(struct i2c_client *i2c, u8 reg, u8 *dest);
extern int nxe2000_bulk_read(struct i2c_client *i2c, u8 reg, int count,
		u8 *buf);
extern int nxe2000_write_reg(struct i2c_client *i2c, u8 reg, u8 value);
extern int nxe2000_bulk_write(struct i2c_client *i2c, u8 reg, int count,
		u8 *buf);
extern int nxe2000_update_reg(struct i2c_client *i2c, u8 reg, u8 val, u8 mask);
