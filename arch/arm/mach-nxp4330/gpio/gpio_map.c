...
static void init_lowcost(void)
{
    printk(KERN_WARNING "%s: LOWCOST GPIO mapping\n", __func__);
        /* GPIO Port A */
        /* VOUT_PCLK_R      - pin  A0 */
        /* PVD0             - pin  A1 */
        /* PVD1             - pin  A2 */
    ...
    gpio_map[TOUCHSCREEN_Y2]    = LF3000_GPIO_PORT_B | 24;    //FIXME CTP_RST_RTP_Y2_R
    gpio_map[TOUCHSCREEN_X2]    = LF3000_GPIO_PORT_B | 25;    //FIXME CTP_INT_RTP_X2_R
    gpio_map[TOUCHSCREEN_CTL]   = LF3000_GPIO_PORT_B | 26;    //TOUCHSCREEN_CTL
        /* N/C              - pin B27 */
        /* N/C              - pin B28 */
    gpio_map[BUTTON_VOLUMEUP]   = LF3000_GPIO_PORT_B | 29;
    gpio_map[BUTTON_VOLUMEDOWN] = LF3000_GPIO_PORT_B | 30;
    ...
    gpio_map[ACCEL_INT]         = LF3000_GPIO_PORT_C | 6;
        ...
        /* SSPTXD2          - pin C12 */
        /* N/C              - pin C13 */
    gpio_map[REAR_CAM_RESET_L]  = LF3000_GPIO_PORT_C | 14;  //FIXME VID0_RESET_L
    gpio_map[FRONT_CAM_ENABLE_L]= LF3000_GPIO_PORT_C | 15;    //FIXME VID2_ENA_L
    gpio_map[FRONT_CAM_RESET_L] = LF3000_GPIO_PORT_C | 16;    //FIXME VID2_RESET_L
        /* N/C              - pin C17 */
        /* SDCLK2           - pin C18 */
        ...
        /* SDDAT22          - pin C22 */
        /* SDDAT23          - pin C23 */
    gpio_map[REAR_CAM_ENABLE_L] = LF3000_GPIO_PORT_C | 24;  //FIXME VID0_ENA_L
        /* nSWAIT           - pin C25 */    //FIXME - do we need to map this ?
        /* N/C              - pin C26 */
        /* N/C              - pin C27 */
        /* N/C              - pin C28 */
    ...
    gpio_map[I2C_SCL1]          = LF3000_GPIO_PORT_D | 4;
    gpio_map[I2C_SDA1]          = LF3000_GPIO_PORT_D | 5;
    gpio_map[TOUCHSCREEN_Y1]    = LF3000_GPIO_PORT_D | 6;   //FIXME CTP_RST_RTP_Y1_R
    gpio_map[TOUCHSCREEN_X1]    = LF3000_GPIO_PORT_D | 7;   //FIXME CTP_RST_RTP_X1_R
