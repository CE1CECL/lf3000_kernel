...
obj-$(CONFIG_VIDEO_NXP_CAPTURE)			+=  $(PROTOTYPE)/$(MODULES)/nx_clkgen.o
...
obj-$(CONFIG_NEXELL_SOC_DISP_LCDIF)		+=  $(PROTOTYPE)/$(MODULES)/nx_lcdif.o \
								   			$(PROTOTYPE)/$(MODULES)/nx_ssp.o

obj-$(CONFIG_V4L2_LF2000)   			+=  $(PROTOTYPE)/$(MODULES)/nx_vip.o
obj-$(CONFIG_V4L2_LF2000)   			+=  $(PROTOTYPE)/$(MODULES)/nx_clkgen.o

obj-$(CONFIG_SND_NEXELL_I2S)			+=  $(PROTOTYPE)/$(MODULES)/nx_clkgen.o

obj-$(CONFIG_NXP_OUT_RESOLUTION_CONVERTER) += $(PROTOTYPE)/$(MODULES)/nx_resconv.o
