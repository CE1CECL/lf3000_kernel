...
#define PAD_PWROFF_GPIOALV0    (PAD_MODE_IN   | PAD_LEVEL_LOW  | PAD_PULL_UP  )				//
#define PAD_PWROFF_GPIOALV1    (PAD_MODE_OUT  | PAD_LEVEL_LOW  | PAD_PULL_OFF )				//
#define PAD_PWROFF_GPIOALV2    (PAD_MODE_OUT  | PAD_LEVEL_LOW  | PAD_PULL_OFF )				//
#define PAD_PWROFF_GPIOALV3    (PAD_MODE_OUT  | PAD_LEVEL_LOW  | PAD_PULL_OFF )				//
#define PAD_PWROFF_GPIOALV4    (PAD_MODE_OUT  | PAD_LEVEL_LOW  | PAD_PULL_OFF )				//
#define PAD_PWROFF_GPIOALV5    (PAD_MODE_OUT  | PAD_LEVEL_LOW  | PAD_PULL_OFF )				//


static void set_alive_for_power_off(void)
{
	int index, bit;
	...
	const U32 pads[] = {
	PAD_PWROFF_GPIOALV0, PAD_PWROFF_GPIOALV1, PAD_PWROFF_GPIOALV2,
	PAD_PWROFF_GPIOALV3, PAD_PWROFF_GPIOALV4, PAD_PWROFF_GPIOALV5
	};
...
{
	pm_power_off = NULL; //this function should be called once only
	int cpu, cur = smp_processor_id();

	set_alive_for_power_off();
