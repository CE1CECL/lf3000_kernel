...
static struct nxp_clk_periph clk_periphs [] = {
	CLK_PERI_1S(DEV_NAME_TIMER		,  0, CLK_ID_TIMER_0	, PHY_BASEADDR_CLKGEN14, (_PLL0_)),
	CLK_PERI_1S(DEV_NAME_TIMER		,  1, CLK_ID_TIMER_1	, PHY_BASEADDR_CLKGEN0 , (_PLL0_)),
	CLK_PERI_1S(DEV_NAME_TIMER		,  2, CLK_ID_TIMER_2	, PHY_BASEADDR_CLKGEN1 , (_PLL0_)),
	CLK_PERI_1S(DEV_NAME_TIMER		,  3, CLK_ID_TIMER_3	, PHY_BASEADDR_CLKGEN2 , (_PLL0_)),
	CLK_PERI_1S(DEV_NAME_UART		,  0, CLK_ID_UART_0	    , PHY_BASEADDR_CLKGEN22, (_PLL1_)),
	CLK_PERI_1S(DEV_NAME_UART		,  1, CLK_ID_UART_1	    , PHY_BASEADDR_CLKGEN24, (_PLL1_)),
	CLK_PERI_1S(DEV_NAME_UART		,  2, CLK_ID_UART_2	    , PHY_BASEADDR_CLKGEN23, (_PLL1_)),
	CLK_PERI_1S(DEV_NAME_UART		,  3, CLK_ID_UART_3	    , PHY_BASEADDR_CLKGEN25, (_PLL1_)),
	CLK_PERI_1S(DEV_NAME_UART		,  4, CLK_ID_UART_4	    , PHY_BASEADDR_CLKGEN26, (_PLL1_)),
	CLK_PERI_1S(DEV_NAME_UART		,  5, CLK_ID_UART_5	    , PHY_BASEADDR_CLKGEN27, (_PLL1_)),
	CLK_PERI_1S(DEV_NAME_PWM		,  0, CLK_ID_PWM_0	    , PHY_BASEADDR_CLKGEN13, (_PLL0_)),
	CLK_PERI_1S(DEV_NAME_PWM		,  1, CLK_ID_PWM_1	    , PHY_BASEADDR_CLKGEN3 , (_PLL0_)),
	CLK_PERI_1S(DEV_NAME_PWM		,  2, CLK_ID_PWM_2	    , PHY_BASEADDR_CLKGEN4 , (_PLL0_)),
	CLK_PERI_1S(DEV_NAME_PWM		,  3, CLK_ID_PWM_3	    , PHY_BASEADDR_CLKGEN5 , (_PLL0_)),
	CLK_PERI_0S(DEV_NAME_I2C		,  0, CLK_ID_I2C_0	    , PHY_BASEADDR_CLKGEN6 , (_GATE_PCLK_)),
	CLK_PERI_0S(DEV_NAME_I2C		,  1, CLK_ID_I2C_1	    , PHY_BASEADDR_CLKGEN7 , (_GATE_PCLK_)),
	CLK_PERI_0S(DEV_NAME_I2C		,  2, CLK_ID_I2C_2	    , PHY_BASEADDR_CLKGEN8 , (_GATE_PCLK_)),
	CLK_PERI_2S(DEV_NAME_I2S		,  0, CLK_ID_I2S_0	    , PHY_BASEADDR_CLKGEN15, (_PLL1_|_EXTCLK1_), (_CLKOUTn_)),
	CLK_PERI_2S(DEV_NAME_I2S		,  1, CLK_ID_I2S_1	    , PHY_BASEADDR_CLKGEN16, (_PLL1_|_EXTCLK1_), (_CLKOUTn_)),
	CLK_PERI_2S(DEV_NAME_I2S		,  2, CLK_ID_I2S_2	    , PHY_BASEADDR_CLKGEN17, (_PLL1_|_EXTCLK1_), (_CLKOUTn_)),
	CLK_PERI_1S(DEV_NAME_SDHC		,  0, CLK_ID_SDHC_0	    , PHY_BASEADDR_CLKGEN18, (_PLL2_|_GATE_PCLK_)),
	CLK_PERI_1S(DEV_NAME_SDHC		,  1, CLK_ID_SDHC_1	    , PHY_BASEADDR_CLKGEN19, (_PLL2_|_GATE_PCLK_)),
	CLK_PERI_1S(DEV_NAME_SDHC		,  2, CLK_ID_SDHC_2	    , PHY_BASEADDR_CLKGEN20, (_PLL2_|_GATE_PCLK_)),
	CLK_PERI_1S(DEV_NAME_SPI		,  0, CLK_ID_SPI_0	    , PHY_BASEADDR_CLKGEN37, (_PLL2_)),
	CLK_PERI_1S(DEV_NAME_SPI		,  1, CLK_ID_SPI_1	    , PHY_BASEADDR_CLKGEN38, (_PLL2_)),
	CLK_PERI_1S(DEV_NAME_SPI		,  2, CLK_ID_SPI_2		, PHY_BASEADDR_CLKGEN39, (_PLL2_)),
//	CLK_PERI_1S(DEV_NAME_VIP		,  0, CLK_ID_VIP_0	    , PHY_BASEADDR_CLKGEN30, (_PLL3_|_EXTCLK1_|_GATE_BCLK_)),
//	CLK_PERI_1S(DEV_NAME_VIP		,  1, CLK_ID_VIP_1	    , PHY_BASEADDR_CLKGEN31, (_PLL3_|_EXTCLK1_|_EXTCLK2_|_GATE_BCLK_)),
	CLK_PERI_1S(DEV_NAME_MIPI		, -1, CLK_ID_MIPI		, PHY_BASEADDR_CLKGEN9 , (_PLL2_)),
	CLK_PERI_2S(DEV_NAME_GMAC		, -1, CLK_ID_GMAC		, PHY_BASEADDR_CLKGEN10, (_PLL3_|_EXTCLK1_), (_CLKOUTn_)),
	CLK_PERI_1S(DEV_NAME_SPDIF_TX	, -1, CLK_ID_SPDIF_TX	, PHY_BASEADDR_CLKGEN11, (_PLL1_)),
...
//	CLK_PERI_1S(DEV_NAME_MALI		, -1, CLK_ID_MALI		, PHY_BASEADDR_CLKGEN21, (_GATE_BCLK_)),
	...
	CLK_PERI_1S(DEV_NAME_PPM		, -1, CLK_ID_PPM		, PHY_BASEADDR_CLKGEN29, (_PLL2_)),
	CLK_PERI_2S(DEV_NAME_USB2HOST	, -1, CLK_ID_USB2HOST	, PHY_BASEADDR_CLKGEN32, (_PLL3_), (_PLL3_|_EXTCLK1_)),
...
static inline void peri_clk_rate(void *base, int level, int src, int div)
{
	...
	div -= 1;
	printk(KERN_INFO "%s base=%p, level=%d, src=%d, div=%d+1, CLKGEN[%d]=%x\n", __FUNCTION__, base, level, src, div, level << 1, val);
}
				...
				int align, int *divide)
{
	...
	//printk(KERN_INFO "get_rate_divide clk: rate=%ld request=%ld div=%d max=%d adv=%d\n", rate, request, div, max, adv);

	if (!div) {
		if (divide)
			*divide = 1;
		//printk(KERN_INFO "get_rate_divide clk: rate=%ld divide=%d \n", rate, *divide);
		return rate;
	}
	...
	if (div != adv &&
		...
		div = adv;
	//printk(KERN_INFO "get_rate_divide clk: div=%d \n",div);

	div = (div > max ? max : div);
	if (divide)
		*divide = div;
		
	//printk(KERN_INFO "get_rate_divide clk: rate=%ld div=%d divide=%d \n", rate, div, rate/div);
	return (rate/div);
}
...
long clk_round_rate(struct clk *clk, unsigned long rate)
{
	...
	//printk(KERN_INFO "clk: %s.%d reqeust = %ld s1= %d, s2=%d, d1=%d, d2=%d, level=%d, mask=0x%08x \n",
		//peri->dev_name, peri->dev_id, rate, s1, s2, d1, d2, level, mask);
...
next:
	for (n = 0; INPUT_CLKS > n; n++) {
		//printk(KERN_INFO "clk: %s.%d n=%d rate = %ld\n", peri->dev_name, peri->dev_id, n, rate);
		...
		for (i = 0; level > i ; i++)
		{
			...
			//printk(KERN_INFO "clk: %s.%d i = %d rate = %ld\n", peri->dev_name, peri->dev_id, i, rate);
		}
		...
		rate_hz = rate;
		freq_hz = clock_hz;
		//printk(KERN_INFO "clk: %s.%d rate_hz = %ld freq_hz = %ld s1= %d, s2=%d, d1=%d, d2=%d\n",
			//peri->dev_name, peri->dev_id, rate_hz, freq_hz, s1, s2, d1, d2);
	}
...
int clk_set_rate(struct clk *clk, unsigned long rate)
{
	...
	for (i = 0; peri->level > i ; i++)	{
		...
		//if(strncmp(peri->dev_name, "nxp-sdhc.2", 10) == 0)
		//{
			//sdmmc_flag = 1;
		//}
		//if(sdmmc_flag)
		...
		//printk("clk: %s.%d (%p) set_rate [%d] src[%d] div[%d]\n",
			//peri->dev_name, peri->dev_id, peri->base_addr, i, s, d);
		//printk(KERN_INFO "clk: %s.%d 0x%08x set_rate [%d] src[%d] div[%d]\n",
			//peri->dev_name, peri->dev_id, peri->base_addr, i, s, d);
	}
...
void __init nxp_cpu_clock_init(void)
{
	...
	case LF3000_BOARD_LOWCOST:
		...
		#define DVO2	15
		#define DVO3	21
		printk(KERN_INFO "G3D PLL%d = %d before\n", pll_get_dvo(3), G3D_BCLK_RATE(pll_get_dvo(3)));
		clkpwr->DVOREG[3] = (1<<CLKSRC) | ((2-1)<<DVO0) | ((2-1)<<DVO1);
		printk(KERN_INFO "G3D PLL%d = %d after \n", pll_get_dvo(3), G3D_BCLK_RATE(pll_get_dvo(3)));
		break;
	default:
		break;
	}
	...
	for (i = 0; count > i; i++, cdev++) {
		...
		//printk(KERN_INFO "[%2d] clock : 0x%p, %s.%d, id %2d\n",
			//i, peri->base_addr, peri->dev_name, peri->dev_id, (int)peri->periph_id);
	...
	for (i = 0; CLKLINK_NUM > i; i++ ) {
		for (n = 0; PERIPH_NUM > n; n++, cdev++) {
			...
			if (peri->periph_id == clk_link[i].id) {
				...
				cl->link = &cdev->clk;
				pr_debug("[%2d] clock : %s -> %s.%d\n",
					CLKPLL_NUM+PERIPH_NUM+i, cl->name, peri->dev_name, peri->dev_id);
			}
		}
		cdev = clk_dev_get(CLKPLL_NUM);
	}
